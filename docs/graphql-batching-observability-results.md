...
See the companion document: `graphql-batching-observability-implementation.md` for a complete implementation plan to add dedicated GraphQL batch observability.
